...
class LeaveApplicationLog extends Model
{
    ...
    public const ACTION_ADMIN_CANCELLED = 'ADMIN_CANCELLED';

    public const ACTION_EMPLOYEE_CANCELLED = 'EMPLOYEE_CANCELLED';
    ...
    public const ACTION_HR_APPLICATION_EDITED = 'HR_APPLICATION_EDITED';

    public const ACTION_HR_APPLICATION_EDIT_REQUESTED = 'HR_APPLICATION_EDIT_REQUESTED';

    public const ACTION_HR_APPLICATION_EDIT_REQUEST_APPROVED = 'HR_APPLICATION_EDIT_REQUEST_APPROVED';

    public const ACTION_HR_APPLICATION_EDIT_REQUEST_REJECTED = 'HR_APPLICATION_EDIT_REQUEST_REJECTED';
